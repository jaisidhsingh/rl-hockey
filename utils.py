...
class ReplayBuffer(object):
    ...
    def push(self, state, action, reward, next_state, done):
        self.state_store[self.pointer] = state
        self.action_store[self.pointer] = action
        self.reward_store[self.pointer] = reward
        self.next_state_store[self.pointer] = next_state
...
def setup_td3_args():
    ...
    # Hyper-params: limits
    parser.add_argument("--per-epoch-steps", type=int, default=10000)
